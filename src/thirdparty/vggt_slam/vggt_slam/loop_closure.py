...
from ..thirdparty.salad.salad.eval import load_model


_SALAD_CKPT = Path("./output/thirdparty_ckpt/vggtslam/dino_salad.ckpt")
...
class ImageRetrieval:
    def __init__(self, input_size=224):
        ...
        if not _SALAD_CKPT.exists():
            raise FileNotFoundError(f"SALAD checkpoint not found at {_SALAD_CKPT}")
        self.model = load_model(_SALAD_CKPT)
        self.model.eval()
