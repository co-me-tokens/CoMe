 ...
 * 
 */
at::Tensor co_me_token_merge_cuda_legacy(const int64_t prefix_cnt, at::Tensor tokens, at::Tensor dst_lidx, c10::optional<at::Tensor> out_ptr);
 ...
 */
at::Tensor co_me_token_merge_scan_legacy(const int64_t prefix_cnt, const int64_t G, at::Tensor mask);
